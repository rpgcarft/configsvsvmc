                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow mb-4 d-none d-lg-block">
                            <div class="card-body">
								...
								<a class="lp-menu" href="?page=backend&menu=discord"><img src="/webshop/img/discord.png" style="width: 30px;"></i>&nbsp;จัดการ Discord</a>
								<a class="lp-menu" href="?page=backend&menu=announce"><i class="fa fa-announce"></i>&nbsp;จัดการ announce</a>
