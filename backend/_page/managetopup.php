			...
			<form name="topup_settings" method="POST">
				<div class="row">
					<div class="col-md-6 mb-3">
			            <label for="wallet_email">Email</label>
			            <input type="email" class="form-control" id="wallet_email" name="wallet_email" required="" value="<?php echo $wallet['email']; ?>">
			        </div>
			        <div class="col-md-6 mb-3">
			        ...
			        <div class="col-md-12 mb-3">
			            <label for="wallet_reference">Reference Token</label>
